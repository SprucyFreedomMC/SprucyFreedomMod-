...
public enum TFM_PlayerRank
{
    ...
    SFM_DEVELOPER("a " + ChatColor.DARK_PURPLE + "Developer", ChatColor.DARK_PURPLE + "(Dev)"),
    LEAD_DEVELOPER("the " + ChatColor.BLUE + "Lead Developer", ChatColor.BLUE  + "(Lead Dev)"),
    WEB_DEVELOPER("a " + ChatColor.GREEN + "Web Developer", ChatColor.GREEN + "(Web Dev)"),
    SPEC_EXEC("a " + ChatColor.YELLOW + "Executive", ChatColor.YELLOW + "(Executive)"),
    ...
    public static TFM_PlayerRank fromSender(CommandSender sender)
    {
        ...
        else if (sender.getName().equals("XGreenPlayz12") || sender.getName().equals("xYuchi") || sender.getName().equals("ZekySky"))
        {
            return OWNER;
        }
        else if (sender.getName().equals("xShadowing") || sender.getName().equals("xFadeing"))
        {
        ...
        else if (SFM_DEVELOPERS.contains(sender.getName()))
        {
            return SFM_DEVELOPER;
        }
